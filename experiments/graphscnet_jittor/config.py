...
_C.exp.root_dir = osp.dirname(osp.dirname(_C.exp.working_dir))
_C.exp.output_dir =osp.join(_C.exp.root_dir, 'output', _C.exp.name) #osp.join("..", "..", "outputs", _C.exp.name)
_C.exp.snapshot_dir = osp.join(_C.exp.output_dir, "snapshots")
...
ensure_dir(_C.exp.snapshot_dir)
...
# data
_C.data = edict()
_C.data.dataset_dir = "/home/yuzhiyuan/4DMatch"
...
_C.model.transformer.num_blocks = 2
