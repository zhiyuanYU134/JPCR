...
from PCR_Jittor.utils.common import ensure_dir
...
# data
_C.data = edict()
_C.data.dataset_root = '/home/yzy/Desktop/icmi'
_C.data.scannet_root = '/home/yzy/Desktop/scannet/scans'
_C.data.shapenet_root = '/home/yzy/Desktop/ShapeNetCore'
_C.data.scan2cad_root = '/home/yzy/Desktop/scan2cad.npy'
_C.data.newscan2cad_root = '/home/yzy/Desktop/new_scan2cad/'
_C.data.jittor_scan2cad_root = '/media/yuzhiyuan/03c478b2-d9df-4ee8-8547-651f6b1d4270/home/yzy/Desktop/jittor_scan2cad_data/'
_C.data.scan2cad = '/home/yzy/Desktop/3/vision3d-clean/scan2cad_download/full_annotations.json'
_C.data.modelnet40='/home/yzy/Desktop/modelnet40'


_C.instance_mask_thre=0.6
_C.geodesic_radis=0.15
_C.cluster_thre=0.2
_C.cluster_refine=True
_C.max_neighboor=16#local transformer
_C.max_sample_neighboor=16 #max_sample_neighboor<max_neighboor
# train data
_C.train = edict()
...
_C.finematch_max_point = 256
_C.fine_matching_max_num_corr = 15000
_C.fine_matching_min_num_corr = 4
# loss - Coarse level
...
_C.loss.weight_mask_loss = 1.0

_C.re_thre = 15
_C.te_thre = 0.1

# model - Architecture
_C.backbone.architecture = ['simple', 'resnetb']
for i in range(_C.backbone.num_stages - 1):
    _C.backbone.architecture.append('resnetb_strided')
    _C.backbone.architecture.append('resnetb')
    _C.backbone.architecture.append('resnetb')
for i in range(_C.backbone.num_stages  - 3):
    _C.backbone.architecture.append('nearest_upsample')
    _C.backbone.architecture.append('unary')
_C.backbone.architecture.append('nearest_upsample')
_C.backbone.architecture.append('last_unary')
