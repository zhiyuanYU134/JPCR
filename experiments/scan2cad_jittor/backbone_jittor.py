...
from PCR_Jittor.jittor.modules.kpconv import ConvBlock, ResidualBlock, UnaryBlock, LastUnaryBlock, nearest_upsample
...
class KPConvFPN(nn.Module):
    ...
    def execute(self, feats, data_dict):
        feats_list = []
