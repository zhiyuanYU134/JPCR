...
class MultiHeadAttention(nn.Module):
    ...
    def execute(
        ...
        attention_scores = jt.matmul(q, k.transpose(-1, -2))
        ...
        if attention_masks is not None:
            attention_scores = jt.masked_fill(attention_scores,attention_masks, float('-inf'))
...
class TransformerDecoderLayer(nn.Module):
    ...
    def execute(self, input_states, memory_states, input_masks=None, memory_masks=None):
...
class TransformerEncoder(nn.Module):
    ...
    def execute(self, feats, weights=None, masks=None, attention_factors=None, attention_masks=None):
...
class TransformerDecoder(nn.Module):
    ...
    def execute(self, q_feats, s_feats):
